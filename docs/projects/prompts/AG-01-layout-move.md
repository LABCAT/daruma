...
- Old dashboard worker (`apps/opportunity-engine/workers/dashboard/`) is **not** moved — Solid SPA dashboard is AG-02/02a/03; leave old worker behind when the old package is removed
...
- Do **not** create full dashboard UI yet — AG-02 tokens/preview; **AG-02a** SPA reset if Start/Solid 2 was scaffolded; AG-03 shell + auth
